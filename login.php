...
<body style="background:#5F4B8B url('assets/img/teacherbg_login.png') no-repeat left fixed; background-size: 40% auto; height: 100vh; width: 100%; min-height: 100%; display: flex; flex-direction: column;">
...
<div class="page-container" style="flex: 1 0 auto;">
  ...
  <section class="section section-shaped section-lg">
    <div class=" shape-style-6 shape-primary">
      <span></span>
      <span></span>
      <span></span>
      <span></span>
...
<form class="col s12 l5 black-text " method="POST" autocomplete="new-password">
