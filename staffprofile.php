...
<body class="min-vh-100 d-flex flex-column"
      style="background: #5F4B8B repeat left fixed; background-size: 40% auto; width: 100%;">
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="card-body bg-gradient-warning">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src="assets/img/teacherbg_login.png" alt="student" class="rounded-circle" width="150">
                    <div class="mt-3">
                      <h4>                      <?php echo $dbname ?></h4>
                      <p class="text-white mb-1"> <?php echo $dbdept ?> Engineering</p>
                      <p class="text-white font-size-sm">Delhi Skill and Entrepreneurship University</p>
