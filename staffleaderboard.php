...
<body style="background: #5F4B8B;" class="d-flex flex-column min-vh-100" id="top">
  ...
  <section class="section section section-lg">
    ...
    <div class="container" style="max-height: 400px; overflow-y: auto; border: 2px solid #6b21a8; border-radius: 10px; padding: 20px; background-color: #f9f9f9;">
...
<div class="row">
            ...
            {echo "<div class='table-responsive'>
                <table id=\"le\" class=\"table table-striped table-hover table-bordered  text-center \">
